...
@section('content')
    <div class="row">
        <div class = button-create><a href="{{route('user.index')}}" class="btn btn-outline-secondary">Сотрудники</a></div>
        <div class = button-create><a href="{{route('task.create')}}" class="btn btn-outline-primary">Создать задание</a></div>
